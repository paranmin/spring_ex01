...
<html>
  <head>
    <meta charset="UTF-8">
    <title><c:if test="${title ne null and title != ''}">${title } - </c:if>Board</title>
    ...
    <!-- Ionicons -->
    <link href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" rel="styleshee.t" type="text/css" />
    <!-- Theme style -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-book"></i> <span>board</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="${pageContext.request.contextPath }/sboard/listPage"><i class="fa fa-circle-o"></i> List</a></li>
                <li><a href="${pageContext.request.contextPath }/sboard/register"><i class="fa fa-circle-o"></i> Register</a></li>
              </ul>
            </li>
          </ul>
        </section>
